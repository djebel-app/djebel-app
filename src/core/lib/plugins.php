...
class Dj_App_Plugins {
     ...
     * Unlike loadPlugins() this is a single, explicit, lazy require — no scan, no meta, no hooks.
     * $lib may be one id or an array of ids. A bad id or entry is a caller bug and throws;
     * a valid-but-absent lib is soft-skipped (the "load it if it's there" case).
     * Dj_App_Plugins::loadLib('djebel-core-lib-http');
