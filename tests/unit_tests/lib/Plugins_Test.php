...
class Dj_App_Plugins_Test extends TestCase {
    ...
    public function testLoadPluginsCrashBoxKeepsLoggingOffThePublicPage()
    {
        ...
        $crash_box = $this->loadCrashingPlugin($crash_params);
    ...
    /**
     * Loads a plugins dir holding one plugin that throws, and returns what the crash box printed.
    ...
    private function loadCrashingPlugin($params)
    {
        ...
        $this->assertTrue($load_res->isSuccess(), 'the loader carried on past the crash');
