...
class Dj_App_Lib_Test extends TestCase {
    ...
    {
        $res_obj = Dj_App_Lib::loadLib('djebel-test-lib', [ 'dir' => $this->libDir(), ]);
    ...
    public function testLoadLibSoftSkipsAbsentLib()
    {
        ...
        $res_obj = Dj_App_Lib::loadLib('djebel-absent-lib', [ 'dir' => $this->libDir(), ]);
    ...
    {
        $res_obj = Dj_App_Lib::loadLib([ 'djebel-test-lib', 'djebel-absent-lib', ], [ 'dir' => $this->libDir(), ]);
    ...
    public function testLoadLibThrowsOnTraversalId()
    {
        ...
        Dj_App_Lib::loadLib('../../etc/passwd', [ 'dir' => $this->libDir(), ]);
    }
    ...
    public function testLoadLibThrowsOnNonPhpEntry()
    {
        ...
        Dj_App_Lib::loadLib('djebel-test-lib', [ 'dir' => $this->libDir(), 'entry' => 'lib.txt', ]);
    }

    public function testLoadLibIsIdempotent()
    {
        // require_once — loading twice must not fatal and stays successful.
        Dj_App_Lib::loadLib('djebel-test-lib', [ 'dir' => $this->libDir(), ]);
        $res_obj = Dj_App_Lib::loadLib('djebel-test-lib', [ 'dir' => $this->libDir(), ]);
