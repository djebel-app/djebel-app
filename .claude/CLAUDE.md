...
- Mechanics, naming tiers, and the fix-once-pull-everywhere workflow live once, in `docs/developers/plugin-guide.md` (Official plugins and everyone else's → Distribution). Don't restate them here.
